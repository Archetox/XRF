...
#
############################################################################################################
####		Master function to be called by outside python script					####
############################################################################################################

def h5convert(textfile, countfile):
...
############################################################################################################
    ...
    if not textfile or not countfile:
         runmessage = "Please select both ROI and Data files to convert"
    else:
        ...
        runmessage = "Files successfully converted (X steps = " + str(xno) + ", Y steps = " + str(yno) + ")" 
